...
- [x] Criar uma VPC exclusiva para o ambiente da aplicação
- [x] Configurar sub-redes e tabela de rotas
- [x] Criar grupos de segurança definindo regras de acesso (HTTP/HTTPS, SSH, etc.)
- [x] Criar instância EC2 para hospedar a aplicação web
- [x] Atribuir IP público à instância EC2 e garantir acesso externo
- [x] Documentar configurações básicas do ambiente


#### 4.2 Deploy da Aplicação

- [x] Instalar dependências da aplicação na EC2
- [x] Fazer deploy do código na instância
- [x] Configurar variáveis de ambiente
- [x] Testar o funcionamento do sistema em ambiente de nuvem
